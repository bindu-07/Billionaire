...
import com.binduhait.instagram.Adapter.AdapterGroupChat;
...
public class GroupChatActivity extends AppCompatActivity {
    ...
    Toolbar toolbar;
    ImageView grpicon,back,attachbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(GroupChatActivity.this, GroupChatFragment.class);
    ...
    private void loadMygroupRole() {
        ...
        reference.child(grouid).child("Participants").orderByChild("id").equalTo(firebaseAuth.getUid())
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds:dataSnapshot.getChildren()){
                            ...
                            try {
                                Glide.with(GroupChatActivity.this).load(groupicon).into(grpicon);
                            }
                            catch (Exception e){
