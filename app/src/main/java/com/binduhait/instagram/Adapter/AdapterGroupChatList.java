...
import com.binduhait.instagram.GroupChatActivity;
import com.binduhait.instagram.Model.ModelGroupChatList;
...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        try {
            Glide.with(context).load(groupIcon).into(holder.icon);
        }
        catch (Exception e){
