...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final UserAdapter.ImageViewHolder holder, final int position) {
        ...
        //holder.btn_message.setText("Message");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                            if(dataSnapshot1.exists()) {
                                Toast.makeText(mContext,"You Can't message ..You are blocked by this User",Toast.LENGTH_LONG).show();
                                return;
                            }
                        }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public Button btn_follow, btn_message;
        ...
        public ImageViewHolder(View itemView) {
            ...
            btn_message = itemView.findViewById(R.id.message_chat);
        }
    }
